...
Jabber to oparty o XML, architekturę klient-server oraz filozofię
open-source system powiadamiania, który wykorzystuje rozproszoną sieć
serwerów, do przekazywania danych pomiędzy nimi i klientami Jabber.

Ten pakiet zawiera starą wersję jabberd, głównie na potrzeby starszych
serwisów Jabbera.
...
Ten pakiet zawiera pliki niezbędne do tworzenia rozszerzeń serwera
jabberd-1.4.x.
